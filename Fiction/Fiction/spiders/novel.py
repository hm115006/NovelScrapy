...
class NovelSpider(scrapy.Spider):
    ...
    def parse_read(self, response):
        ...
        #yield item
        read_url = response.xpath('//a[@class="reader"]/@href').extract()[0]#http://www.quanshuwang.com/book/154/154796
    ...
    def parse_content(self, response):
        ...
        #ovelid_first = response.xpath('//div[@class="backs"]/a[2]/@href').extract_first()
        #novelid_second = novelid_first.split('/')[5]
        #novelid = int(novelid_second)
